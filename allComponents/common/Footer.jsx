    ...
    return(
        ...
        <div className="flex flex-col lg:flex-row gap-5 lg:gap-0 pt-20 pb-15 justify-between pl-[5%] pr-[5%]">
          <div className="flex flex-col gap-4">
            <img src="/Surgical Packs.png" alt="Surgical Packs" className="w-[124px] h-[50px]"/>
          ...
          <div className="flex flex-col gap-3">
            ...
            <a href="home.html" className="mt-3 text-[#716B66] font-poppins text-[16px] not-italic font-normal leading-normal">Home</a>
            <a href="about.html" className="text-[#716B66] font-poppins text-[16px] not-italic font-normal leading-normal">About Us</a>
            <a href="products.html" className="text-[#716B66] font-poppins text-[16px] not-italic font-normal leading-normal">Products</a>
            <a href="contact.html" className="text-[#716B66] font-poppins text-[16px] not-italic font-normal leading-normal">Contact Us</a>
          </div>
          <div className="flex flex-col gap-5">
            ...
            <div className="flex gap-2">
              <input type="text" className="flex  w-[180px] sm:w-[280px] px-[22px] py-[14px] items-start gap-[10px] bg-white shadow-[0_0_4px_rgba(0,0,0,0.15)] " placeholder="Enter Your Email"/>
                <button className="w-[100px] sm:w-[110px] h-[49px] flex-shrink-0 bg-gradient-to-r from-[#1B7F75] to-[#4EA291]">Subscribe</button>
            </div>
          </div>
        </div>
