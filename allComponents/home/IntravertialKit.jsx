    ...
    return(
        <section className="mt-[8%] mb-[8%] lg:pl-[11%] pl-[5%] pr-[5%] gap-5 flex flex-col lg:flex-row items-center">
          ...
          <div className="flex flex-col gap-1">
            ...
            <button className="flex items-center gap-2 bg-[linear-gradient(90deg,#1B7F75_0%,#4EA291_100%)] text-white font-poppins font-medium px-6 sm:py-2 w-[174px] sm:h-[45px] h-[40px] mt-4 lg:mt-7 cursor-pointer">
