          ...
          <div className="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 gap-1 ">
            <div className="flex flex-col bg-white border  border-black/10 p-5 gap-3 items-center">
              <div className="  pt-[6px] pb-[7px]">
                <img src="/product1.png" alt="product1" className="w-[132px] h-[145px]" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-[#0F0F0F] font-poppins text-[16px] not-italic font-medium leading-normal ">Vulval Toilet Cleaning Pack</p>
            ...
            <div className="flex flex-col bg-white border  border-black/10 p-5 gap-3 items-center">
              <div className="pt-[6px] pb-[7px]">
                <img src="/product2.png" alt="product1" className="w-[132px] h-[145px]" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-[#0F0F0F] font-poppins text-[16px] not-italic font-medium leading-normal ">Vulval Toilet Cleaning Pack</p>
                <div className="flex gap-1">
            ...
            <div className="flex flex-col bg-white border  border-black/10 p-5 gap-3 items-center">
              <div className="pt-[6px] pb-[7px]">
                <img src="/product3.png" alt="product1" className="w-[132px] h-[145px]" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-[#0F0F0F] font-poppins text-[16px] not-italic font-medium leading-normal ">Vulval Toilet Cleaning Pack</p>
                <div className="flex gap-1">
            ...
            <div className="flex flex-col bg-white border  border-black/10 p-5 gap-3 items-center">
              <div className="pt-[6px] pb-[7px]">
                <img src="/product4.png" alt="product1" className="w-[132px] h-[145px]" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-[#0F0F0F] font-poppins text-[16px] not-italic font-medium leading-normal ">Vulval Toilet Cleaning Pack</p>
                <div className="flex gap-1">
            ...
            <div className="preview hidden sm:flex flex-col bg-white border  border-black/10 p-5 gap-3 items-center">
              <div className="pt-[6px] pb-[7px]">
                <img src="/product5.png" alt="product1" className="w-[132px] h-[145px]" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-[#0F0F0F] font-poppins text-[16px] not-italic font-medium leading-normal ">Vulval Toilet Cleaning Pack</p>
                <div className="flex gap-1">
            ...
            <div className="preview hidden md:flex flex-col bg-white border  border-black/10 p-5 gap-3 items-center">
              <div className="pt-[6px] pb-[7px]">
                <img src="/product6.png" alt="product1" className="w-[132px] h-[145px]" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-[#0F0F0F] font-poppins text-[16px] not-italic font-medium leading-normal ">Vulval Toilet Cleaning Pack</p>
                <div className="flex gap-1">
            ...
            <div className="preview hidden md:flex flex-col bg-white border  border-black/10 p-5 gap-3 items-center">
              <div className="pt-[6px] pb-[7px]">
                <img src="/product7.png" alt="product1" className="w-[132px] h-[145px]" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-[#0F0F0F] font-poppins text-[16px] not-italic font-medium leading-normal ">Vulval Toilet Cleaning Pack</p>
                <div className="flex gap-1">
            ...
            <div className="preview hidden md:flex flex-col bg-white border  border-black/10 p-5 gap-3 items-center">
              <div className="pt-[6px] pb-[7px]">
                <img src="/product8.png" alt="product1" className="w-[132px] h-[145px]" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-[#0F0F0F] font-poppins text-[16px] not-italic font-medium leading-normal ">Vulval Toilet Cleaning Pack</p>
                <div className="flex gap-1">
            ...
            <div className="preview hidden md:flex flex-col bg-white border  border-black/10 p-5 gap-3 items-center">
              <div className="pt-[6px] pb-[7px]">
                <img src="/product9.png" alt="product1" className="w-[132px] h-[145px]" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-[#0F0F0F] font-poppins text-[16px] not-italic font-medium leading-normal ">Vulval Toilet Cleaning Pack</p>
                <div className="flex gap-1">
            ...
            <div className="preview hidden sm:flex flex-col bg-white border  border-black/10 p-5 gap-3 items-center">
              <div className="pt-[6px] pb-[7px]">
                <img src="product10.png" alt="product1" className="w-[132px] h-[145px]" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-[#0F0F0F] font-poppins text-[16px] not-italic font-medium leading-normal ">Vulval Toilet Cleaning Pack</p>
                <div className="flex gap-1">
