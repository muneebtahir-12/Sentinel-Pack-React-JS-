function Vision(){
    return(
        <section className="md:pl-[7%] md:pr-[7%] pl-[5%] pr-[5%] flex flex-col-reverse lg:justify-between lg:flex-row gap-5 lg:gap-10 mt-[5%] mb-[10%] items-center">
  <img src="/vision.png" alt="vision" className="lg:w-[420px] lg:h-[540px] w-[100%]  sm:w-[65%]  "/>
