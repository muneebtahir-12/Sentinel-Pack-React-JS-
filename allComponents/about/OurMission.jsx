function Mission() {
    return(
        <section className="md:pl-[7%] md:pr-[5%] pl-[5%] pr-[5%] flex flex-col lg:justify-between lg:flex-row  mt-[5%] mb-[10%] items-center lg:gap-10 gap-5">
  ...
  <img src="/mission.png" alt="Company" class="lg:w-[420px] lg:h-[540px] w-[100%]  sm:w-[65%] "/>
